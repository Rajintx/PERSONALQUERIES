...
SELECT AssetID,
	...
	AMI.MENUCODE,
	BATCHCODE,
  IIF((DPBOOKVALUE- DEPRECIATION_VALUE)>@SALVAGEVALUE ,(DPBOOKVALUE- DEPRECIATION_VALUE) ,iif(DPBOOKVALUE<@salvagevalue,DPBOOKVALUE ,@SALVAGEVALUE))    BOOKVALUE,
	COSTPRICE ORIGNALCOST,
	 IIF((DPBOOKVALUE- DEPRECIATION_VALUE)>@SALVAGEVALUE ,DEPRECIATION_VALUE ,IIF(DPBOOKVALUE<@SALVAGEVALUE,0,DPBOOKVALUE-@SALVAGEVALUE))  DEPRECIATION,
	@CURRENTMONTH [MONTHS],
