...
BEGIN
	SELECT [POOL],
		...
		SUM(CASE 
				...
				ELSE 0
				END) [DEPRECIATION FOR THE MONTH OF ~SHRAWAN],
		SUM(CASE 
				WHEN MON = 2
					THEN DEPRECIATION_VALUE
				ELSE 0
				END) [DEPRECIATION FOR THE MONTH OF ~BHADRA],
		SUM(CASE 
				WHEN MON = 3
					THEN DEPRECIATION_VALUE
				ELSE 0
				END) [DEPRECIATION FOR THE MONTH OF ~ASOJ],
		SUM(CASE 
				WHEN MON = 4
					THEN DEPRECIATION_VALUE
				ELSE 0
				END) [DEPRECIATION FOR THE MONTH OF ~KARTIK],
		SUM(CASE 
				WHEN MON = 5
					THEN DEPRECIATION_VALUE
				ELSE 0
				END) [DEPRECIATION FOR THE MONTH OF ~MANGSIR],
		SUM(CASE 
				WHEN MON = 6
					THEN DEPRECIATION_VALUE
				ELSE 0
				END) [DEPRECIATION FOR THE MONTH OF ~POUSH],
		SUM(CASE 
				WHEN MON = 7
					THEN DEPRECIATION_VALUE
				ELSE 0
				END) [DEPRECIATION FOR THE MONTH OF ~MAGH],
		SUM(CASE 
				WHEN MON = 8
					THEN DEPRECIATION_VALUE
				ELSE 0
				END) [DEPRECIATION FOR THE MONTH OF ~FAGUN],
		SUM(CASE 
				WHEN MON = 9
					THEN DEPRECIATION_VALUE
				ELSE 0
				END) [DEPRECIATION FOR THE MONTH OF ~CHAITRA],
		SUM(CASE 
				WHEN MON = 10
					THEN DEPRECIATION_VALUE
				ELSE 0
				END) [DEPRECIATION FOR THE MONTH OF ~BAISAKH],
		SUM(CASE 
				WHEN MON = 11
					THEN DEPRECIATION_VALUE
				ELSE 0
				END) [DEPRECIATION FOR THE MONTH OF ~JESTHA],
		SUM(CASE 
				WHEN MON = 12
					THEN DEPRECIATION_VALUE
				ELSE 0
				END) [DEPRECIATION FOR THE MONTH OF ~ASAR],
	...
	SELECT [POOL],
		...
		SUM(CASE 
				WHEN ASSETMON = 0
					THEN BOOKVALUE
				ELSE 0
				END) [BOOKVALUE~OPENING],
		SUM(CASE 
				WHEN ASSETMON <> 0
					THEN BOOKVALUE
				ELSE 0
				END) [BOOKVALUE~ADDITION],
