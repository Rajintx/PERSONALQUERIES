...
--SELECT @DATE1='2022-05-04',@DATE2='2023-05-22',@MODE=0,@SUMMARY=0
   ...
   select LC.VOUCHERNO DISPATCHVOUCHER,SSM.NAME AGENT,OM.VCHRNO ORDERNO,LID.MCODE,LID.ITEMDESC ,LID.MRP,LID.QUANTITY,OM.BSDATE ORDERMITI,TM.VCHRNO INVOICENO,TM.TRNAC,TM.BSDATE INVOICEMITI,LC.DATE DISPATCHDATE,TP.WAREHOUSE GODOWN ,RA.ACNAME ,COUNT(*) OVER() ALLCOUNT from TRNMAIN TM    LEFT join LOADCHARTVOUCHERDETAIL LD ON  TM.VCHRNO=LD.REFBILL  
